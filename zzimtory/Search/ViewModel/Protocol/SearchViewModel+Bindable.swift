...
// 이를 위해 SearchViewModel이라는 프로토콜로 ViewModel을 추상화하여,
...
// SearchViewModel을 사용하는 View와 ViewModel 간의 바인딩을 간결하게 하기 위해 Bindable 프로토콜을 정의하였습니다.
// SearchViewModelBindable 프로토콜은 동일한 ViewModel을 공유하는 View들 간의 일관성을 유지하기 위한 약속으로,
